...
class GeneralResponseButtons(discord.ui.View):
    ...
    async def blurple_button(
        ...
        await interaction.response.edit_message(
            content=f"This is merely a test of button functionality!", view=self
        )
...
class ButtonLinks:
    github = discord.ui.Button(
        ...
        url="https://github.com/iodeslykos",
        emoji="<:iodes:750029680907780146>",
    )
...
class AdminActionPrompt(discord.ui.View):
    ...
    async def cancel_button(
        self, button: discord.ui.Button, interaction: discord.InteractionMessage
    ):
        button.style = discord.ButtonStyle.grey
        for child in self.children:
            child.disabled = True
